  ...
  // 工作台
  {
    ...
    children: [
      ...
      // 工作台-散杂货发布
      {
        ...
        name: "bulkCargo",
        component: () =>
          import("@/views/workbench/release/bulkCargo/index.vue"),
      },
      // 工作台-船舶备件发布
      {
      ...
      // 工作台-船舶备件编辑
      {
        ...
        name: "spartList",
        component: () =>
          import("@/views/workbench/spart/spartList/spartEdit.vue"),
      },
      // 工作台-我的商铺
      {
      ...
      // 工作台-订单列表
      {
        ...
        name: "orderList",
        component: () =>
          import("@/views/workbench/orderList/bulkShip/index.vue"),
      },
      // 工作台-散货船订单
      {
      ...
      // 工作台-集装箱订单
      {
        ...
        name: "containerList",
        component: () =>
          import("@/views/workbench/orderList/container/index.vue"),
      },
    ],
  },
  // 加盟工作台
