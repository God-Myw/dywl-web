					...
					<div class="home_search_input">
						<div class="search_input_launch">
							...
							<div class="search_input_recoin">
								<input v-model="bookingStart" type="text" placeholder="从哪里起运" />
							</div>
						</div>
						...
						<div class="search_input_terminus">
							<i></i>
							<div class="search_input_recoin">
								<input v-model="bookingEnd" type="text" placeholder="货到哪里去" />
							</div>
						</div>
								...
								<div class="inter_list_left">
									...
									<div class="inter_list_se">
										...
										<div>
											<span></span>
											<span v-if="item.voyageLine.length > 0">
												<i class="voyageend" v-for="(ite, idx) in item.voyageLine" :key="idx"
					...
					<li v-for="item in intVoyageData" :key="item.guid">
						<div class="inter_item">
							...
							<div class="inter_list">
								...
								<div class="inter_list_e" @click="toDetvointernal(item)">
									<div>查看详情</div>
								</div>
							</div>
						</div>
								...
								.inter_list_left {
									...
									.inter_list_se {
										...
										div:nth-child(2) {
											...
											span:nth-child(1) {
												background: url("../../../assets/voyagetime/蒙版组 180@2x.png") no-repeat;
								...
								.inter_list_left {
									...
									.inter_list_se {
										...
										div:nth-child(1) {
											...
											span:nth-child(1) {
												background: url("../../../assets/voyagetime/蒙版组 179@2x.png") no-repeat;
												background-size: 20px 20px;
												width: 20px;
												height: 20px;
												margin-right: 12px;
