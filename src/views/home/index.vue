    ...
    <div class="home_container">
      ...
      <div class="container_list" v-if="activeName == 'first'">
        <ul v-loading="loading3">
          <li
            @click="SeckillDetails(item.type)"
            v-for="item in seckillData"
            :key="item.guid"
          >
            ...
            <div class="container_list_time">
              <div class="time_foreshow" v-if="item.type == 1">
                {{ item.startTime }} 开始
              </div>
          ...
          <li v-for="item in newauctioData" :key="item.guid">
            ...
            <div class="container_list_box">
              <div class="box_auctio_l">
                ...
                <div class="container_list_time">
                  <div v-if="item.type == 1" class="time_foreshow">
                    {{ item.startTime }} 开始
                  </div>
          ...
          <li v-for="item in bookingData" :key="item.guid">
            ...
            <div class="container_list_box">
              <div class="box_pile">
                <div></div>
                <div>
                  <span>20GP</span><span style="padding: 0 2px">/</span
                  ><span>40GP</span><span style="padding: 0 2px">/</span
                  ><span>40HQ</span>
                </div>
              </div>
              <div class="box_seckill">
      ...
      <div class="straygoods_content">
        <div class="straygoods_content_l">
          ...
          <div class="straygoods_freight_seach">
            ...
            <div class="straygoods_freight_bott">
              <div class="straygoods_freight_bott_l">
                客服计算价格后将消息通知您
              </div>
        ...
        <div class="straygoods_content_r">
          ...
          <div class="straygoods_pallet">
            <span
              @click="foreignpallet()"
              :class="pallet == 'foreign' ? 'pallet_optfor' : ''"
              >推荐国际货盘</span
            >
            <span
              @click="internalpallet()"
              :class="pallet == 'internal' ? 'pallet_optfor' : ''"
              >推荐国内货盘</span
            >
          </div>
            ...
            <ul v-loading="loading">
              <li v-for="(item, index) in foreignData" :key="item.guid">
                <div class="pallet_cont_li_h">
                  ...
                  <i v-if="item.goodsVolume && pallet == 'foreign'"
                    >{{ item.goodsVolume }}m³</i
                  >
                </div>
      ...
      <div class="voyage_content">
        ...
        <div class="voyage_content_r">
          ...
          <div class="straygoods_voyage">
            <span
              @click="foreignvoyage()"
              :class="voyage == 'foreign' ? 'voyage_optfor' : ''"
              >推荐国际航次</span
            >
            <span
              @click="internalvoyage()"
              :class="voyage == 'internal' ? 'voyage_optfor' : ''"
              >推荐国内航次</span
            >
          </div>
          <div class="voyage_cont">
            <ul v-loading="loading2">
              <li
                @click="toDetvoforeign()"
                v-for="item in forVoyageData"
                :key="item.guid"
              >
                ...
                <div class="voyage_cont_li_b">
                  ...
                  <div class="li_pallet_place">
                    ...
                    <div class="li_pallet_place_e">
                      ...
                      <div
                        v-if="
                          item.voyageLine.length == 1 && voyage == 'internal'
                        "
                      >
                        待定
                      </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        purpose: [
          { required: true, message: "请填写目的港", trigger: "change" },
        ],
        goodsName: [
          { required: true, message: "请选择货物", trigger: "change" },
        ],
        minton: [
          { required: true, message: "请输入最小吨位", trigger: "blur" },
        ],
        maxton: [
          { required: true, message: "请输入最大吨位", trigger: "blur" },
        ],
      },
      // 测试倒计时
        ...
        .home_search_tab {
          ul {
            ...
            li:hover::after {
              ...
              height: 12px;
              position: absolute;
              background: url("../../assets/homepage/多边形 1@2x (2).png")
                no-repeat;
    ...
    .container_list_auctio {
      ...
      ul {
        ...
        li {
          ...
          .container_seckill_tag {
            position: absolute;
            background: url("../../assets/homepage/组 6947@2x (2).png")
              no-repeat;
            background-size: cover;
            display: block;
            width: 54px;
          ...
          .container_list_box {
            ...
            .box_pile {
              ...
              div:nth-child(1) {
                width: 20px;
                height: 20px;
                background: url("../../assets/homepage/蒙版组 256.png")
                  no-repeat;
                background-size: cover;
              }
              div:nth-child(2) {
        ...
        .straygoods_freight_seach {
          ...
          .straygoods_freight_seach_input {
            ...
            .straygoods_freight_ico {
              ...
              div:nth-child(1) {
                background: url("../../assets/homepage/蒙版组 179.png")
                  no-repeat;
                background-size: cover;
                width: 20px;
                height: 20px;
              ...
              div:nth-child(2) {
                background: url("../../assets/homepage/蒙版组 180.png")
                  no-repeat;
                background-size: cover;
                width: 20px;
                height: 20px;
              ...
              div:nth-child(3) {
                background: url("../../assets/homepage/蒙版组 270.png")
                  no-repeat;
                background-size: cover;
                width: 20px;
                height: 20px;
              ...
              div:nth-child(4) {
                background: url("../../assets/homepage/蒙版组 271.png")
                  no-repeat;
                background-size: cover;
                width: 20px;
                height: 20px;
        ...
        .announce_voyage {
          ...
          .announce_new_voyage {
            ...
            div:nth-child(1) {
              ...
              margin-bottom: 8px;
              span:nth-child(1) {
                background: url("../../assets/homepage/蒙版组 272.png")
                  no-repeat;
                width: 16px;
                height: 16px;
                display: block;
