        ...
        <div class="login_import">
          <div class="login_else">
            ...
            <div class="login_else_c">
              ...
              <div @click="goLogin">Log in now</div>
            </div>
          </div>
          <div class="login_identity">
            <div class="login_identity_correct">
              <el-select
                ...
                style="width: 324px"
              >
                <el-option label="Cargo owner" value="4"></el-option>
                <el-option label="Ship owner" value="5"></el-option>
              </el-select>
            </div>

            <div v-if="identityError" class="login_error">Please select an identity</div>
          </div>
          <div class="login_ID">
            ...
            <div v-if="accountIDError" class="login_error">
              Account cannot be empty, it is recommended to use email
            </div>
          </div>
          <div class="login_input_recoin">
            ...
            <div v-if="tellNumberError" class="login_error">
              Please enter the correct email number
            </div>
          </div>
          <div class="login_input_auth">
            <div class="login_input_auth_correct">
              <div class="auth_input">
                <input v-model="authNumber" placeholder="Get Verification Code" />
              </div>
              <div class="auth_flagstaff"></div>
              <div class="auth_authCode" @click="authCode">
                <div v-if="authCodeStutas">Send</div>
                <div v-else style="color: #4791ff">Send Again{{ time }}s</div>
              </div>
            </div>
          ...
          <div class="login_input_password">
            <div class="login_input_password_correct">
              <div class="login_input_password_l">
                <input
                  v-model="passWord"
                  :type="inputType"
                  placeholder="Password 8-16 digit combination of letters and numbers, no special characters"
                />
              </div>
              <div
                @click="changeEye"
            ...
            <div v-if="passWordError" class="login_error">
              Password 8-16 digit combination of letters and numbers
            </div>
          </div>

          <div class="login_into" @click="goRegister">Register Now</div>
