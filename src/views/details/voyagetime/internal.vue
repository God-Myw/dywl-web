<template>
  <div class="det_foreign">
    ...
    <div class="transport">
      ...
      <div class="transport_begin">
        <span>起运港</span>
        <span></span>
        <span>宁波港</span>
      </div>
      <div class="transport_vertical"></div>
      <div class="transport_aim">
        <span>目的港</span>
        <span></span>
        <span>青岛、上海、广州-南沙、海口</span>
      </div>
      <div class="transport_cleanship">
        <span>空船日期</span>
        <span>2021-09-04 ~ 2021-09-15</span>
      </div>
      <div class="transport_across"></div>
      <div class="transpor_remark">
        <span>备注</span>
        <span
          >高级高科技设备使用特种钢材、运的时候需保护好，谢谢！属性用以表示哈哈哈
          checkbox 的不确定状态，一般用于实现全选的效果。</span
        >
      </div>
    </div>
  </div>
