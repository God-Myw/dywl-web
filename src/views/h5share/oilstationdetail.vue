	...
	<div class="oilstation-content" :class="{ intervoyageinland: clientSide }">
		...
		<div class="garage_cont">
			<div class="garage_address">
				<div class="garage_address_img">
					<img v-if="!dataList.logo" src="../../assets/container/组 7875@2x.png" alt="" />
			...
			<div class="garage_nav">
				<div class="garage_nav_header">
					...
					<div class="garage_nav_header_r">
						...
						<div>仅供参考以<span style="color: #cb9529">站内实际挂牌价</span>为准</div>
					</div>
				</div>
				<!-- 数据列表 -->
				<div class="garage_nav_list">
					<div class="garage_nav_list_item" v-for="(item, index) in dataList.fules" :key="index">
		...
		<van-dialog v-model="show" title="是否打开道裕物流App" :show-confirm-button="false">
			<div class="btnCs">
				...
				<div class="btn-right" @click="handleErrorFn">确定</div>
			</div>
		</van-dialog>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
					...
					if (res.code == "0000") {
						...
						wx.ready(function () {
							var s_title = "道裕物流", // 分享标题
								...
								s_imgUrl = "https://www.dylnet.cn/container/img/oilstationdet.jpg"; // 分享图标
			...
			// 列表数据
			async getList() {
				let res = await axios.get("https://www.dylnet.cn/api/business/oil/getOilDetailForApp", {
					headers: {
				...
				.garage_address_det {
					...
					div:nth-child(2) {
						...
						span {
							...
							width: 12px;
							height: 12px;
							background: url("../../assets/container/蒙版组 312@2x.png") no-repeat;
					...
					div:nth-child(3) {
						...
						span {
							...
							width: 12px;
							height: 12px;
							background: url("../../assets/container/蒙版组 313@2x.png") no-repeat;
							background-size: 12px 12px;
						}
					}
				}
						...
						.garage_item_l {
							.garage_item_l_header {
								...
								span:nth-child(1) {
									...
									width: 24px;
									height: 24px;
									background: url("../../assets/container/蒙版组 333@2x.png") no-repeat;
